...
except ImportError:  # pragma: no cover - optional dependency for point cloud export only
    o3d = None
...
class PointCloudWriter:
    ...
    def write(self, point_cloud: Union[np.ndarray, object]) -> None:
        ...
        if o3d is None:
            raise ImportError("open3d is required for PointCloudWriter.write(). Please install open3d to use this feature.")
        ...
        o3d.io_ros.write_point_cloud(str(file_path), o3d_point_cloud)
        self.counter += 1

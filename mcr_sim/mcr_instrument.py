...
class Instrument(Sofa.Core.Controller):
    ...
    def __init__(
        ...
        self.index_mag_visu = [
            int(nume_nodes_viz*(length_body+length_tip-magnets[0].length)),
        ...
        topoLines_guide.addObject(
            ...
            spireDiameter=250.0,
            numEdgesCollis=[num_edges_collis_body, num_edges_collis_tip],
            printLog=False,
            template='Rigid3d',
            spireHeight=0.0,
        ...
        # VISU ROS
        CathVisuROS = self.InstrumentCombined.addChild(
            'CathVisuROS')
        ...
        self.MO_visu = CathVisuROS.addObject(
            'MechanicalObject',
